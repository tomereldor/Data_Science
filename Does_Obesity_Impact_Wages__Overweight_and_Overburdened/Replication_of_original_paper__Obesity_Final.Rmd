---
title: 'Replication of "Overweight and Overburdened" '
output:
...
###Replication: Mahalanobis Distance Matching
...
mahal.imb<-imbalance(data.mahal$d_obese,data=data.mahal,drop = 
                    c("d_obese","CPS_hourly_rec","distance","weights",
                   "sample_wt","person_id","ln_smwage","CPS_hourly_rec",
                   "d_educ9_12","d_educ13_up", "d_AFQT_0_25","d_AFQT_25_50","d_AFQT_50_75","d_AFQT_75_100",
...
###Replication: Creating Talbes and LaTex Figures.
```{r}
...
stargazer(m1.orig, m1, type="text", title="Estimates of the obesity wage offset for health insurance, Original and Matched Samples", 
